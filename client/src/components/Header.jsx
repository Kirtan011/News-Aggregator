  ...
  return (
    <header>
      <nav className="fixed top-0 left-0 w-full h-20 bg-gray-800 z-10 flex items-center justify-around">
        <h3 className="relative heading font-extrabold md:basis-1/6 text-5xl xs:basis-4/12 z-50 mb-5 mt-5">
          SPLICER
        </h3>
        ...
        >
          ...
          <li className="dropdown-li">
            <Link
              className="no-underline font-semibold flex items-center gap-3"
              onClick={() => {
            ...
            <ul
              className={
                showCategoryDropdown
                  ? "dropdown p-14 mb-2 show-dropdown w-40"
                  : "dropdown p-14 w-40"
              }
            >
